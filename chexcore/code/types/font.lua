...
function Font.new(path, fontSize)
    local newFont
    ...
    if Font._cache[fontID] then
        ...
        if #path>0 then -- non-default font
            newFont._realFont = love.graphics.newFont(path, fontSize or Font._fontSize)
        else -- default font
            newFont._realFont = love.graphics.newFont(fontSize or Font._fontSize)
        end
